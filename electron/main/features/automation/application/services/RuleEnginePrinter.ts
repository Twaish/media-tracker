import { Action, HttpAction } from '../../domain/ast/Action'
import {
  BinaryExpression,
  Expression,
  ObjectExpression,
...
import { IRuleEnginePrinter } from '../interfaces/IRuleEnginePrinter'

export class RuleEnginePrinter implements IRuleEnginePrinter {
